...
H.apply_palette = function(palette, use_cterm)
  ...
  hi('CursorLineFold', {fg=p.base0C, bg=p.base00, attr=nil,         sp=nil})
  hi('CursorLineNr',   {fg=p.base04, bg=p.base00, attr=nil,         sp=nil})
  hi('CursorLineSign', {fg=p.base03, bg=p.base00, attr=nil,         sp=nil})
  ...
  hi('LineNrAbove',    {fg=p.base03, bg=p.base00, attr=nil,         sp=nil})
  hi('LineNrBelow',    {fg=p.base03, bg=p.base00, attr=nil,         sp=nil})
  ...
  hi('MatchParen',     {fg=p.base0C, bg=p.base02, attr=nil,         sp=nil})
  ...
  hi('DiagnosticUnderlineHint',  {fg=nil, bg=nil, attr='undercurl', sp=p.base0D})
  hi('DiagnosticUnderlineInfo',  {fg=nil, bg=nil, attr='undercurl', sp=p.base0C})
  hi('DiagnosticUnderlineOk',    {fg=nil, bg=nil, attr='undercurl', sp=p.base0B})
  ...
  hi('FloatBorder', {fg=p.base02, bg=nil, attr=nil, sp=nil})
  ...
  if H.has_integration('echasnovski/mini.nvim') then
    ...
    hi('MiniDiffSignAdd',     {fg=p.base0B, bg=p.base00, attr=nil, sp=nil})
    hi('MiniDiffSignChange',  {fg=p.base0E, bg=p.base00, attr=nil, sp=nil})
    hi('MiniDiffSignDelete',  {fg=p.base08, bg=p.base00, attr=nil, sp=nil})
    ...
    hi('MiniFilesTitle',          {fg=p.base05, bg=p.base00, attr=nil,    sp=nil})
    hi('MiniFilesTitleFocused',   {fg=p.base0A, bg=p.base00, attr='bold', sp=nil})
  ...
  if H.has_integration('hrsh7th/nvim-cmp') then
    ...
    hi('CmpItemKind',           {fg=p.base0F, bg=nil,      attr=nil,    sp=nil})
    hi('CmpItemMenu',           {fg=p.base05, bg=nil,      attr=nil,    sp=nil})
  ...
  if H.has_integration('jinh0/eyeliner.nvim') then
    hi('EyelinerPrimary',   {fg=p.base08, bg=nil, attr='underline,', sp=nil})
    hi('EyelinerSecondary', {fg=p.base05, bg=nil, attr='underline',  sp=nil})
  end
  ...
  if H.has_integration('lewis6991/gitsigns.nvim') then
    ...
    hi('GitSignsChange',          {fg=p.base0E, bg=p.base00, attr=nil, sp=nil})
  ...
  if H.has_integration('folke/snacks.nvim') then
    hi('SnacksIndent',       {fg=p.base01, bg=nil, attr='nocombine', sp=nil})
    hi('SnacksIndentScope',  {fg=p.base0F, bg=nil, attr='nocombine', sp=nil})
    hi('SnacksPickerSearch', {fg=p.base09, bg=nil, attr='nocombine', sp=nil})
  end
...
H.darken = function(hex, pct)
	pct = 1 - pct
	local rgb = H.hex2rgb(hex)
	local darker_rgb = vim.tbl_map(function(x)
		return math.floor(x * pct)
	end, rgb)
	return H.rgb2hex(darker_rgb)
end
